...
int main(int argc, char** argv)
{
  ...
  try
  {
    ...
    {
        if (dcontrol::toggle_smartscreen(false))
        {
            printf("disabled smartscreen!\n");
        }
        else
        {
            printf("failed to disable smartscreen!\n");
        }
    ...
    {
        printf("Failed to disable defender... try disabling tamper protection!!!!!!!!!!!!!!\n");
    }
    ...
    if (dcontrol::enable_defender())
    {
        ...
        {
            printf("Enabled windows defender but failed to disable smartscreen!\n");
        }
    }
    else
    {
